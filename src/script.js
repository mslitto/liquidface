...
const main = async () => {
    ...
    const texture = await promisifiedLoader(textureLoader, 'textures/skybox.jpg')
 ...
 */
     ...
     * Textures
     */
    const colorTexture = await promisifiedLoader(textureLoader, '/textures/color.jpg')
    ...
    const gltf = await new Promise((resolve, reject) => {
        gltfLoader.load('/models/face_07.gltf', resolve, () => { }, reject)
    })
